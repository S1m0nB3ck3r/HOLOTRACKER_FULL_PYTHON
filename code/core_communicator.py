...
class CoreCommunicator:
    ...
    def _process_command(self, command: Command) -> Result:
        ...
        try:
            ...
            return Result(command.type, False, {}, str(e))
    ...
    def _allocate_resources(self, params: dict) -> tuple[float, str]:
        ...
        self.core.perform_preprocessing(params)
        
        # Allocation GPU
        result_msg = self.core.initialize_test_mode(params)
    ...
    def _handle_allocate(self, command: Command) -> Result:
        ...
        try:
            ...
            return Result(CommandType.ALLOCATE, False, {}, str(e))
    ...
    def _handle_enter_test_mode(self, command: Command) -> Result:
        ...
        try:
            ...
            return Result(CommandType.ENTER_TEST_MODE, False, {}, str(e))
    ...
    def _handle_process_hologram(self, command: Command) -> Result:
        ...
        try:
            ...
            return Result(CommandType.PROCESS_HOLOGRAM, False, {}, str(e))
    ...
    def _handle_process_hologram_batch(self, command: Command) -> Result:
        ...
        try:
            ...
            return Result(CommandType.PROCESS_HOLOGRAM_BATCH, False, {}, str(e))
    ...
    def _handle_change_parameter(self, command: Command) -> Result:
        ...
        try:
            ...
            reallocation_params = ['holo_size_x', 'holo_size_y', 'nb_plan_reconstruit']
            
            # Mettre à jour le paramètre
            self.core.parameters[param_name] = param_value
            ...
            if param_name in reallocation_params:
                ...
                allocation_time, _ = self._allocate_resources(self.core.parameters)
            else:
            ...
            return Result(CommandType.CHANGE_PARAMETER, False, {}, str(e))
    ...
    def _handle_exit_test_mode(self, command: Command) -> Result:
        ...
        try:
            ...
            return Result(CommandType.EXIT_TEST_MODE, False, {}, str(e))
    ...
    def _handle_enter_batch_mode(self, command: Command) -> Result:
        ...
        try:
            ...
            return Result(CommandType.ENTER_BATCH_MODE, False, {}, str(e))
    ...
    def _handle_exit_batch_mode(self, command: Command) -> Result:
        ...
        try:
            ...
            return Result(CommandType.EXIT_BATCH_MODE, False, {}, str(e))
    ...
    def _handle_extract_object_slices(self, command: Command) -> Result:
        ...
        try:
            ...
            print(f"🔍 Core: Extracting slices for object #{object_num}")
            print(f"📍 Position: ({position[0]:.3f}, {position[1]:.3f}, {position[2]:.3f}) µm")
            ...
            print(f"❌ Core: Error extracting slices: {str(e)}")
